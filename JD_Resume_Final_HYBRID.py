...
# SMART HYBRID: LLM for JD parsing only, regex for rest (saves 90% of tokens)
try:
    from hybrid_smart_validator import HybridSmartValidator as EnhancedResumeValidator
